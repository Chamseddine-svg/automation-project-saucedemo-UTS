...
Test All Items Option For Standard User
    ...
    Log    === ✓ TEST ALL ITEMS TERMINE ===    console=yes
...
Test About Option Standard User
    ...
    Log    === ✓ TEST ABOUT TERMINE ===    console=yes

Test Reset App State Standard User
    [Documentation]    Test de l'option "Reset App State" du menu burger 
    ...                Vérifie que le badge du panier est vidé et que les boutons sont restaurés
...
Test About Option Problem User
    ...
    ...    Fail    Page Saucelabs non ouverte 
    ...
    Log    === ✓ TEST ABOUT TERMINÉ ===    console=yes
